...
export const SCHEDULE: ScheduleItem[] = [
	...
	},
	{
		...
		description: `12 избрани отбора ще представят идеята си пред бизнес ориентарино жури, а проектът с най-добра бизнес идея и потенциал за превръщане в реален продукт ще получи специална награда. Посетителите могат да гледат презентациите на място в София Тех Парк.`,
		icon: '',
		pos: 'left',
	},
	{
