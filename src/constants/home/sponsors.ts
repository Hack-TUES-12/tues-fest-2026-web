...
const GAMMA_SPONSORS = [
	{
		...
		description:
		"Последният продукт на Акселс Софт бори проблема с дезинформацията и пропагандата в интернет, като предоставяме инструменти на организации да управляват своите общества и да подтискат разпространението на дезинформация.",
  	},
	{
