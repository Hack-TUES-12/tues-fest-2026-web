...
export const PROJECTS = [
    ...
    {
        "id": 3,
        "title": "Платформа за автоматизирано създаване, управление и премахване на изолирани облачни среди за разработка и тестване чрез GitOps подход и интелигентно управление на ресурси (Проекта на Габчо)",
        "category": "networks",
